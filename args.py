...
parser.add_argument('--noise_dir', default='/home/michal/Documents/Speech-enhancement/data/Train/noise', type=str)

parser.add_argument('--voice_dir', default='/home/michal/Documents/Speech-enhancement/data/Train/clean_voice', type=str)
#folders where to save spectrograms, time series and sounds for training / QC
parser.add_argument('--path_save_spectrogram', default='/home/michal/Documents/Speech-enhancement/data/Train/spectogram/', type=str)

parser.add_argument('--path_save_time_serie', default='/home/michal/Documents/Speech-enhancement/data/Train/time_serie/', type=str)
...
parser.add_argument('--audio_dir_prediction', default='/home/michal/Documents/Speech-enhancement/data/Test/sound/', type=str)
#directory to save the denoise sound (prediction mode)
parser.add_argument('--dir_save_prediction', default='/home/michal/Documents/Speech-enhancement/data/Test/clean_voice/', type=str)
#Noisy sound file to denoise (prediction mode)
parser.add_argument('--audio_input_prediction', default=['temp.wav'], type=list)
#File name of sound output of denoise prediction
parser.add_argument('--audio_output_prediction', default='temp.wav', type=str)
